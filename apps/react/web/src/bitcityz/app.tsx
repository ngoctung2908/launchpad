    ...
    <div className="wrapper">
      ...
      <main>
        ...
        <div className="container others">
          ...
          <section className="container d-flex flex-column justify-content-center align-items-center section-upcoming-project">
            <img src="/assets/img/launch/ido-project.png" />
            <h3 className="text-large">Upcoming project</h3>
            {[1, 2, 3].map((item, i) => (
              <div key={i} className="card-project col-9 mt-3 mb-3">
          ...
          <div className="sections-launch">
            <section className="container d-flex flex-column justify-content-center align-items-center section-launch-pool">
            ...
            <section className="section-launch-projects">
              ...
              Apply to launch
                ...
                <h3 className="title-launchpad col-4">
